        ...
        await GetAllCities().then(res => {
            if (res.data.status === "Success") {
                res.data.result.map(item => {
                    item.action = <div><Button type="primary" onClick={() => { this.showEditModel(item.city_Id) }} size="sm"><i class="fas fa-pencil-alt"></i> </Button> <Popconfirm title="Are you sure to delete this City?"
